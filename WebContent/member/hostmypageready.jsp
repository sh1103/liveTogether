				...
				<ul class="mypagebar">
					<li class="num1"><a
						href="${pageContext.request.contextPath}/member/HostMyPageLookOk.me">내
							정보조회</a></li>
					<li class="num2"><a
						href="${pageContext.request.contextPath}/member/HostMyPageOk.me.me">내
							정보수정</a></li>
					<li class="num3"><a
										...
										<c:choose>
											<c:when test="${search != null}">
												<td><c:if test="${startPage > 1}">
														<a
															href="${pageContext.request.contextPath}/member/HostMyPageReadyOk.me?page=1">&lt;&lt;&nbsp;&nbsp;</a>
														<a
															href="${pageContext.request.contextPath}/member/HostMyPageReadyOk.me?page=${startPage -1}">&lt;&nbsp;&nbsp;</a>
														...
														<c:choose>
															...
															<c:otherwise>
																<a
																	href="${pageContext.request.contextPath}/member/HostMyPageReadyOk.me?page=${i}"><c:out
																		value="${i}" /></a>&nbsp;&nbsp;
								</c:otherwise>
														</c:choose>
													</c:forEach> <c:if test="${endPage < realEndPage}">
														<a
															href="${pageContext.request.contextPath}/member/HostMyPageReadyOk.me?page=${endPage + 1}">&nbsp;&nbsp;&gt;</a>
														<a
															href="${pageContext.request.contextPath}/member/HostMyPageReadyOk.me?page=${realEndPage}">&nbsp;&nbsp;&gt;&gt;</a>
													</c:if></td>
											</c:when>
											<c:otherwise>
												<td><c:if test="${startPage > 1}">
