									...
									<div class="contract-table">
										<div class="tab1">
											<div class="b1 active a1" role="tabpanel" id="lease">
												<img src="${pageContext.request.contextPath}/images/contract_0.png">
											</div>
											<div class="a1 a2" role="tabpanel" id="bargain">
												<img src="${pageContext.request.contextPath}/images/contract_1.png">
											</div>
											<div class="a1 a2" role="tabpanel" id="housing">
												<img src="${pageContext.request.contextPath}/images/contract_2.png" style="width: 540px">
											</div>
											<div class="a1 a2" role="tabpanel" id="store">
												<img src="${pageContext.request.contextPath}/images/contract_3.png" style="width:540px">
											</div>	
										</div>
...
안전한 거래를 위해 가치살자의 방 찾기에서 제공하는 계약서 양식입니다.<br>필요한 계약서를 다운받아 이용하세요.
                    </div>
                    	<ul class="contract-btn" role="tablist">
                    		<li role="presentation" class="contract-btn-li active">
                    			<a href="#target" class="btns" id="leaseBtn" aria-controls="부동산임대차" role="tab" data-toggle="tab" aria-expanded="true">
                    			부동산 임대차 계약서
                    			</a>
                    		</li>
                    		
                    			<li role="presentation" class="contract-btn-li">
                    			<a href="#target" class="btns" id="bargainBtn" aria-controls="부동산매매" role="tab" data-toggle="tab" aria-expanded="true">
                    			부동산 매매 계약서
                    			</a>
                    		</li>
                    		
                    			<li role="presentation" class="contract-btn-li">
                    			<a href="#target" class="btns" id="housingBtn" aria-controls="주택임대차" role="tab" data-toggle="tab" aria-expanded="true">
                    			주택 임대차 계약서
                    			</a>
                    		</li>
                    		
                    			<li role="presentation" class="contract-btn-li">
                    			<a href="#target" class="btns" id="storeBtn" aria-controls="상가임대차" role="tab" data-toggle="tab" aria-expanded="true">
                    			상가건물 임대차 계약서
                    			</a>
                    		</li>
                    	</ul>
                    	...
                    	<div role="tabpanel" id="lease" class="tab-pane active">
                    		...
                    		<table class="contract-table2">
                    			<tbody>
                    				...
                    				<tr>
                    					...
                    					<td class="t-content" id="construction">임차주택의 표시, 계약내용, 특약사항</td>
                    				</tr>
                    		...
                    		<div class="contract-download-btn">
                    			<a href="#" download="cotract.docx" target="_blank">
...
깡통전세, 중복계약, 먹튀 직거래 사기꾼을 피하는 방법, 첫번째! 계약서 싸인하고 도장 찍기 전에 등기부등본부터 먼저 확인하세요.										
										</div>
										<a href="http://www.iros.go.kr/PMainJ.jsp" target="_blank" class="card-link-btn">대법원 인터넷 등기소 등기부등본 열람 &nbsp;&nbsp;&gt;</a>
								</div>
							</div>
	...
	<script src="${pageContext.request.contextPath}/assets/js/mypagecontract.js"></script>
</body>
</html>