		...
		<div class="mypage">
			...
			<div class="mypagetool">
				<ul class="mypagebar">
					...
					<li class="num4"><a
						href="${pageContext.request.contextPath}/member/HostMemberListOk.me">하우스 관리</a>
					</li>
				</ul>
			</div>
											...
											<c:when test="${roomList != null and fn:length(roomList) >0}">
												<c:forEach var="room" items="${roomList}">
														<tr>
															...
															<td><button onclick="location.href='${pageContext.request.contextPath}/member/HostRestorationOk.me?houseNumber=${room.getHouseNumber()}'">복원</button>
						...
						<c:choose>
							<c:when test="${search != null}">
								<td><c:if test="${startPage > 1}">
										<a
											href="${pageContext.request.contextPath}/member/HostRejectListOk.me?page=1">&lt;&lt;&nbsp;&nbsp;</a>
										<a
											href="${pageContext.request.contextPath}/member/HostRejectListOk.me?page=${startPage -1}">&lt;&nbsp;&nbsp;</a>
										...
										<c:choose>
											...
											<c:otherwise>
												<a
													href="${pageContext.request.contextPath}/member/HostRejectListOk.me?page=${i}"><c:out
														value="${i}" /></a>&nbsp;&nbsp;
								</c:otherwise>
										</c:choose>
									</c:forEach> <c:if test="${endPage < realEndPage}">
										<a
											href="${pageContext.request.contextPath}/member/HostRejectListOk.me?page=${endPage + 1}">&nbsp;&nbsp;&gt;</a>
										<a
											href="${pageContext.request.contextPath}/member/HostRejectListOk.me?page=${realEndPage}">&nbsp;&nbsp;&gt;&gt;</a>
									</c:if></td>
							</c:when>
							<c:otherwise>
								<td><c:if test="${startPage > 1}">
