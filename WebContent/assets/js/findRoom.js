		...
		$.each(houses,function(index, house) {
			...
			if (house.houseGender == "m") {
				houseGender = "남성전용";
					...
					text += '<div class="img-wrap" data-index="' + index + '" style="background:url(\''+contextPath+'/upload/'+house.housefileName+'\'); background-size:cover"></div>'
					text += '<div class="content-wrapper" data-index="' + index + '">'
					text += '<div class="content" data-index="' + index + '">'
					text += '<span class="name" data-index="' + index + '">' + house.houseNumber
					...
					text += '<span class="concept" data-index="' + index + '">'
							+ houseType
							+ '</span><span class="opened-beds" data-index="' + index + '" style="display: inline;">신청가능 '
					text += '<span class="opened-beds-count " data-index="' + index + '">'
							+ house.houseMax + '</span>'
					text += '</span><span class="opened-beds" data-index="' + index + '" style="display: none;">예약가능</span>'
