			...
			<ul class="menu-btn-list">
				...
				<c:choose>
					<c:when test="${memberId eq null}">
						<li class="btn p_menu"><a href="${pageContext.request.contextPath}/member/Login.me">로그인</a>
							<div>
								<ul class="mouseover">
			...
			<div id="nav-menu">
				<div id="button-wrap">
					<input type="button" name="login" value="로그인"
						onclick="location.href='${pageContext.request.contextPath}/member/Login.me'"> <input
