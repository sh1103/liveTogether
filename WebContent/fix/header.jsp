...
<body>
	<header id="header">
				...
				<c:choose>
					<c:when test="${memberId eq null}">
						<li class="btn p_menu"><a
							...
							<div>
								<ul class="mouseover">
									<li><a href="${pageContext.request.contextPath}/member/Join.me">회원가입</a></li>
								</ul>
							</div></li>
					</c:when>
					<c:otherwise>
		...
		<div id="container-mobile">
			<a href="${pageContext.request.contextPath}/main/main.jsp"> <img src="${pageContext.request.contextPath}/images/textLogo2.png"></a>
			<div id="nav-wrap">
	...
	<nav id="nav-mobile">
		<div id="container">
			<div id="nav-menu">
				...
				<div id="menu-wrap">
					<div class="menu">
						<a href="${pageContext.request.contextPath}/house/findRoom.jsp">방
							찾기</a>
					</div>
					<div class="menu">
						<a
							href="${pageContext.request.contextPath}/house/houseregister.jsp">호스팅
							하기</a>
					</div>
					<div class="menu">
						<a href="${pageContext.request.contextPath}/board/info.jsp">가치살자
							소개</a>
					</div>
					<div class="menu">
